...
exports.fillINFDoc = async (inf) => {
  ...
  let data = {
    ...
    Four_Year_Environmental_Engineering: fourYear.Environmental_Engineering ? 'Yes':'No',
    Four_Year_Mechanical_Engineering: fourYear.Mechanical_Engineering ? 'Yes':'No',
    Four_Year_Mineral_and_Metallurgical_Engineering: fourYear.Mineral_and_Metallurgical_Engineering ? 'Yes':'No',
    Four_Year_Mining_Engineering: fourYear.Mining_Engineering ? 'Yes':'No',
    Four_Year_Mining_Machinery_Engineering: fourYear.Mining_Machinery_Engineering ? 'Yes':'No',
    Four_Year_Petroleum_Engineering: fourYear.Petroleum_Engineering ? 'Yes':'No',     
