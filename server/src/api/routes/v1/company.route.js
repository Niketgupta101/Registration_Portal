...
const { saveCompanyDetails, getCompanyDetailsById, getAllCompanyDetails,sendInvitationToAllCompanies, searchCompanyByPattern,fetchAllDefaultInvites,sendCustomEmail} = require('../../controllers/company.controller');
