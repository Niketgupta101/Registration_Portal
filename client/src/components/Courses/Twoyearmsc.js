              ...
              <main className="d-flex justify-content-center">
                <ol class="gradient-list">
                  <li>
                    <Button
                      variant="text"
                      onClick={() => handleShow("Chemistry", twoyearmsc[0])}
                    >
                      <div className="course-name-li">Chemistry</div>
                    </Button>
                  </li>
                  <li>
                    <Button
                      variant="text"
                      onClick={() =>
                        handleShow("Mathematics & Computing", twoyearmsc[1])
                      }
                    >
                  ...
                  <li>
                    <Button
                      variant="text"
                      onClick={() => handleShow("Physics", twoyearmsc[2])}
                    >
                      <div className="course-name-li">Physics</div>
                    </Button>
                  </li>
                </ol>
              </main>
